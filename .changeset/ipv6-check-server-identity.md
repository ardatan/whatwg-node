...
The override is installed lazily on the first HTTPS request, and only when a one-time probe shows the running Node build is affected; healthy Node versions keep the built-in verifier.
